export function EcosLogo({size}) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size || 32} height={size || 32} viewBox="0 0 48 48" className="fill-black dark:fill-white flow">
